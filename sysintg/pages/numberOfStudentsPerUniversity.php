                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							<table width="100%" class="table table-striped table-bordered table-hover" id="students-table">						
								...
								<tbody>
									<?php 
										$student_query = "select count(studentID) as count, university 
														    from students
														group by university";
										...
										while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){ ?>
											<tr>	
												...
												<td class="text-center"><a style="color:blue;" href="studentsOfUniversity.php?university=<?php echo $row['university'];?>">View Students</td>
											</tr>
									<?php } ?>
								</tbody>
							</table>                       
