    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li >
							<a href="accounts.php"><i class="	fa fa-user-plus"></i> Accounts</a>
						</li>
						<li>
        ...
        <div id="page-wrapper">
			...
			<div id="note-alert" style="display:none" class="alert alert-info fade in">
				...
				<strong>Note!</strong> You just removed an account
			</div>
								...
								<tbody>
									<?php 
										$accounts_query = "select * 
														     from accounts
															where username != 'root'";
										$result = mysqli_query($dbc,$accounts_query);
										
										$row_count=mysqli_num_rows($result);
										while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){ ?>
											<tr>
												<td class="text-center"><a style="color:blue;" href="editAccountInformation.php?accountID=<?php echo $row['accountID'];?>">Edit</td>
												<td class="text-center"><a style="color:red;" href="deleteAccountAction.php?accountID=<?php echo $row['accountID'];?>" class="cancel">Remove</td>
